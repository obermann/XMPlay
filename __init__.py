...
class XMPlay(eg.PluginBase):
    ...
    def __init__(self):
        ...
        (actions_xmp_dde.Execute, "ClosePositionSaved", "Close with Position Saved", "Close with position saved. Command No. 11", 11),
        ...
        (actions_xmp_dde.Execute, "PreviousTrack", "Previous Track", "Jump forward to the previous track. Command No. 129", 129),
        (actions_xmp_dde.Execute, "RandomTrack", "Random Track", "Jump forward to the random track. Command No. 130", 130),
        ...
        (actions_xmp_dde.Execute, "BookmarkResume", "Bookmark Resume", "Resume from the bookmark. Command No. 130", 130),
